...
const InteractiveCoinToss: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center w-full my-2 bg-[rgb(var(--c-surface))] border border-[rgb(var(--c-surface-3))] rounded-2xl p-3 shadow-inner">
      ...
      <div className="relative w-24 h-24 [perspective:800px] my-2">
        ...
        >
          ...
          {/* Tails (ก้อย) */}
          <div
            className="absolute inset-0 rounded-full bg-gradient-to-tr from-[rgb(var(--c-line-strong))] via-[rgb(var(--c-butter))] to-[rgb(var(--c-butter-soft))] border-4 border-[rgb(var(--c-line-strong))] shadow-[0_8px_20px_rgba(0,0,0,0.6),inset_0_2px_4px_rgba(255,255,255,0.8),inset_0_-2px_4px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center [backface-visibility:hidden]"
...
const InteractiveMiniDice: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center w-full my-2 bg-[rgb(var(--c-surface))] border border-[rgb(var(--c-surface-3))] rounded-2xl p-3 shadow-inner">
      ...
      <div className="my-2 p-2 rounded-2xl bg-[rgb(var(--c-surface-2))] border border-[rgb(var(--c-surface-3))] shadow-inner">
...
const InteractiveCountdownTimer: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center w-full my-2 bg-[rgb(var(--c-surface))] border-2 border-[rgb(var(--c-surface-3))] rounded-2xl p-3.5 shadow-inner">
      ...
      <div className="flex items-center gap-2 mt-2">
        {!isRunning ? (
          ...
          <button
            type="button"
            onClick={handleReset}
            className="wood-btn-brown px-3 py-1 rounded-xl font-bold text-xs flex items-center gap-1 text-amber-200 border border-[rgb(var(--c-surface-3))]"
          >
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          {secretNumber !== null && (
            <button
              ...
              className="wood-btn-brown px-3 py-1.5 rounded-xl font-bold text-xs flex items-center gap-1 text-amber-200 border border-[rgb(var(--c-surface-3))] shadow active:scale-95 transition"
            >
              {showNumber ? (
                <>
    ...
    switch (type) {
      case 'drink':
        return {
          ...
          badgeBg: 'bg-[rgb(var(--c-surface-2))] text-rose-200 border-[rgb(var(--c-surface-3))]',
      ...
      case 'order_others':
        return {
          ...
          titleColor: 'rpg-text-gold',
          badgeBg: 'bg-[rgb(var(--c-surface-3))] text-amber-200 border-[rgb(var(--c-line-strong))]',
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[rgb(var(--c-surface))]/85 backdrop-blur-sm animate-fadeIn">
      ...
      <div className="wood-panel rounded-3xl p-5 sm:p-6 w-full max-w-sm relative text-center shadow-[0_16px_36px_rgba(0,0,0,0.9)] max-h-[92vh] overflow-y-auto scrollbar-none">
        ...
        {/* Top Header Plaque */}
        <div className="block">
          <div className="inline-block px-4 py-1 rounded-full border border-[rgb(var(--c-butter))]/40 bg-[rgb(var(--c-surface))] shadow-inner mb-2">
        ...
        <div className="w-16 h-16 mx-auto my-2 rounded-2xl bg-[rgb(var(--c-surface))] border-2 border-[rgb(var(--c-surface-3))] flex items-center justify-center shadow-[inset_0_4px_8px_rgba(0,0,0,0.8)]">
          {meta.icon}
        </div>
        ...
        <div className="inline-flex items-center gap-2 text-xs text-amber-100 bg-[rgb(var(--c-surface))] border border-[rgb(var(--c-surface-3))] px-3 py-1.5 rounded-full shadow-inner my-2">
        ...
        {isMyTurn ? (
          ...
          <div className="w-full p-3 rounded-2xl bg-[rgb(var(--c-surface))] border border-[rgb(var(--c-surface-2))] shadow-inner mt-1">
