  ...
  return (
    <Modal isOpen={isOpen} onClose={() => {}} title="⚠️ เงินสดไม่พอจ่าย">
      <div className="flex flex-col gap-3 text-center">
        <div className="flex flex-col items-center gap-1 p-3 rounded-2xl bg-[#2a0e03] border-2 border-orange-700">
        ...
        <div className="grid grid-cols-3 gap-1.5 text-[11px] font-bold">
          <div className="p-2 rounded-xl bg-[#1c0a02] border border-[#4a1c04]">
        ...
        {debt.canCover ? (
          <>
            ...
            <button
              type="button"
              onClick={onBankrupt}
              className="w-full py-2.5 rounded-2xl text-xs font-black bg-[#400e07] border-2 border-[#801c0c] text-rose-200 active:scale-95"
            >
          ...
          <>
            ...
            <button
              type="button"
              onClick={onBankrupt}
              className="w-full py-3 rounded-2xl text-sm font-black bg-[#400e07] border-2 border-[#801c0c] text-rose-100 active:scale-95 flex items-center justify-center gap-2"
            >
