  ...
  if (tile.type !== 'property') {
    ...
    > = {
      ...
      parking: {
        ...
        description: 'จุดพักผ่อนหย่อนใจ ปลอดภัยจากค่าผ่านทาง แต่ต้องหยุดทอย 1 ตา!',
        details: [
          'ไม่มีการเรียกเก็บค่าผ่านทางใดๆ ทั้งสิ้นในช่องนี้',
          'กติกา: เมื่อเดินมาตกช่องนี้ ในตาถัดไปของคุณจะต้อง "หยุดทอยลูกเต๋า 1 ตา" เพื่อพักผ่อน!',
        ],
      },
      go_to_jail: {
