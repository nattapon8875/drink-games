  ...
  if (tile.type !== 'property') {
    ...
    > = {
      ...
      jail: {
        ...
        description: 'สถานที่คุมขังผู้เล่นที่ถูกส่งตัว หรือพื้นที่แวะเยี่ยมเยียน',
        details: [
          'หากเดินมาตกช่องนี้ตามปกติ: คุณมาในฐานะ "ผู้มาเยือน" ปลอดภัย ไม่ต้องเสียเงินและไม่ถูกขัง',
          'หากถูกส่งตัวเข้าคุก: ต้องหยุดรับโทษ 1 ตา (ข้ามตาเดิน) หรือจ่ายค่าปรับ 0.5M เพื่อออกจากคุกทันที',
        ],
      },
      parking: {
        title: 'จุดพักผ่อน (Rest Area)',
        badge: 'จุดพักผ่อน • ปลอดภัย',
        bgGradient: 'from-sky-600 to-blue-800 border-sky-400',
        description: 'จุดพักผ่อนหย่อนใจ ปลอดภัยจากค่าผ่านทาง และเดินต่อได้ตามปกติ',
        details: [
          'ไม่มีการเรียกเก็บค่าผ่านทางใดๆ ทั้งสิ้นในช่องนี้',
          'กติกา: ตกช่องนี้ไม่เสียอะไรและไม่ถูกข้ามตา ถ้าทอยได้แต้มคู่ก็ยังได้ทอยต่อตามปกติ',
        ],
      },
      go_to_jail: {
