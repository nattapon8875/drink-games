...
export const DEFAULT_MONOPOLY_TILES: MonopolyTileRecord[] = [
  ...
  { tile_index: 22, title: 'ทายตัวเลข 0-99', action_text: 'คนตกกดปุ่มสุ่มเลขในระบบ (ปิดไว้ไม่ให้คนอื่นเห็น) แล้วให้เพื่อนในวงทายทีละคน คนตกมีหน้าที่ตอบแค่ "มากกว่า" หรือ "น้อยกว่า" ใครพูดตัวเลขจริงออกมา ดื่ม 1 จิบ!', tile_type: 'challenge', icon: '🔢' },
