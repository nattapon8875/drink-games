    ...
    extend: {
      colors: {
        ...
        rose: {
          ...
          600: "rgb(var(--c-berry-deep) / <alpha-value>)",
          700: "rgb(var(--c-berry-deep) / <alpha-value>)",
          900: "rgb(var(--c-berry-soft) / <alpha-value>)",
        ...
        emerald: {
          ...
          600: "rgb(var(--c-mint-deep) / <alpha-value>)",
          700: "rgb(var(--c-mint-deep) / <alpha-value>)",
          900: "rgb(var(--c-mint-soft) / <alpha-value>)",
          950: "rgb(var(--c-mint-soft) / <alpha-value>)",
        },
        yellow: {
          100: "rgb(var(--c-butter-soft) / <alpha-value>)",
          200: "rgb(var(--c-butter-soft) / <alpha-value>)",
          300: "rgb(var(--c-butter-label) / <alpha-value>)",
          400: "rgb(var(--c-butter-label) / <alpha-value>)",
        ...
        "surface-card": "#1c1c32",
        neon: {
          pink: "rgb(var(--c-berry) / <alpha-value>)",
          cyan: "rgb(var(--c-sky) / <alpha-value>)",
          purple: "rgb(var(--c-grape) / <alpha-value>)",
          yellow: "#ffea00",
          green: "rgb(var(--c-mint) / <alpha-value>)",
        },
      },
      boxShadow: {
